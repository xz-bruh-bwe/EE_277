...
HD_PWD='Z:/EE_277/lab4/lab3_viv/lab3_viv.runs/lab3_bd_axis_subset_converter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_bd_axis_subset_converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_bd_axis_subset_converter_0_0.tcl
