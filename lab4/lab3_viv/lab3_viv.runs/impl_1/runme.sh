...
HD_PWD='Z:/EE_277/lab4/lab3_viv/lab3_viv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab3_bd_wrapper.tcl -notrace
