...
HD_PWD='Z:/EE_277/lab3/lab3_viv/lab3_viv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_bd_wrapper.tcl
