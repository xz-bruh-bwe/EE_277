...
HD_PWD='Z:/EE_277/lab3/lab3_viv/lab3_viv.runs/lab3_bd_AUP_advanced_SoC_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_bd_AUP_advanced_SoC_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_bd_AUP_advanced_SoC_0_5.tcl
