...
#                script (type 'AUP_advanced_SoC_0.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.AUP_advanced_SoC_0 xil_defaultlib.glbl -o AUP_advanced_SoC_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./AUP_advanced_SoC_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key AUP_advanced_SoC_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc AUP_advanced_SoC_0_simv.daidir vcs_lib c.obj)
