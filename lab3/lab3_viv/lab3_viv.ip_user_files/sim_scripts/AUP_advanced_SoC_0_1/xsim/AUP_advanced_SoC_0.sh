...
#
# Script generated by Vivado on Sat Sep 27 22:15:06 -0700 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : AUP_advanced_SoC_0.sh
...
#
# Usage        : AUP_advanced_SoC_0.sh
#                AUP_advanced_SoC_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AUP_advanced_SoC_0.sh [-reset_run]
#                AUP_advanced_SoC_0.sh [-reset_log]
#                AUP_advanced_SoC_0.sh [-help]
#
...
# script info
echo -e "AUP_advanced_SoC_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AUP_advanced_SoC_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot AUP_advanced_SoC_0 xil_defaultlib.AUP_advanced_SoC_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim AUP_advanced_SoC_0 -key {Behavioral:sim_1:Functional:AUP_advanced_SoC_0} -tclbatch cmd.tcl -protoinst "protoinst_files/lab3_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb AUP_advanced_SoC_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./AUP_advanced_SoC_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: AUP_advanced_SoC_0.sh [-help]\n\
Usage: AUP_advanced_SoC_0.sh [-step]\n\
Usage: AUP_advanced_SoC_0.sh [-lib_map_path]\n\
Usage: AUP_advanced_SoC_0.sh [-reset_run]\n\
Usage: AUP_advanced_SoC_0.sh [-reset_log]\n\
Usage: AUP_advanced_SoC_0.sh [-keep_index]\n\
Usage: AUP_advanced_SoC_0.sh [-noclean_files]\n\n\
